...
public final class Constants {
  ...
  public static class DriveConstants {
    ...
    public static final double kSlowSpeed = 1.0;
    ...
    public static final double velocityThreshold = 0.02;
  };
  ...
  public static class FieldConstants {
    ...
    public static final Translation2d leftC2 = new Translation2d(1.2716 + 0.03, -0.165 - 0.005); // + 0.04 untested
    public static final Translation2d rightC2 = new Translation2d(1.2716 + 0.03, 0.165 + 0.0025);
  ...
  public static class LEDConstants {
    ...
    public static final int middleFirstIndex = 12;
    public static final int middleLastIndex = 42;
    ...
    public static final LEDPattern autoAligningPattern = LEDPattern.solid(new Color(255, 0, 255)).blink(blinkInterval);
